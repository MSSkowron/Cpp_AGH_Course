...
1. Prosze utworzyć plik mylist.h, oraz dokonac nastepujacej implementacji:
   ...
   Punktacja przydzielana za nastepujace metody (jak testy):
    ...
    6. jesli kopiowanie (konstruktor kopiujacy i operator przypisania) jest niemozliwe dla listy     ?? What does it mean impossible
...
constexpr const char* const SURNAME   = "Skowron";
constexpr const char* const MAIL    = "mskowron@student.agh.edu.pl";
constexpr const char* const BOOK_ID = "405743";
